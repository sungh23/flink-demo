 ...
 * @author sungaohua
 */
public class Flink09_Window_Time_Sliding {
    public static void main(String[] args) throws Exception {
        ...
        //开启基于时间的滑动窗口   参数一 窗口大小  参数二 步进大小
        WindowedStream<Tuple2<String, Long>, String, TimeWindow> window = keyedStream.window(SlidingProcessingTimeWindows.of(Time.seconds(6),Time.seconds(2)));
